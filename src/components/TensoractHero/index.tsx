...
const wordmarkCharacters = [...'tenso']
  ...
  useLayoutEffect(() => {
    ...
    const context = gsap.context(() => {
      ...
      const measure = () => {
        ...
        const introGap = Math.min(64, Math.max(24, window.innerHeight * 0.08))
      ...
      const scrollDistance = () => {
        ...
        const factor = viewportIsMobile ? 0.72 : isTablet() ? 0.92 : 1.15
      ...
      const timeline = gsap.timeline({
        ...
        scrollTrigger: {
          ...
          onUpdate: ({ progress }) => {
            // Do not let the load-in stagger compete with the scroll transform.
            // Once scrolling starts the wordmark must move as one complete label.
      ...
      <div className="brand-hero__stage">
        <div className="brand-hero__container wire-container">
          ...
          <div className="brand-hero__intro">
            <p className="brand-hero__summary">{copy.body}</p>
          </div>
